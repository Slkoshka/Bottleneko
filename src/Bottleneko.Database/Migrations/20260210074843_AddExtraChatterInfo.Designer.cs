...
namespace Bottleneko.Database.Migrations
{
    ...
    [Migration("20260210074843_AddExtraChatterInfo")]
    partial class AddExtraChatterInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bottleneko.Database.Schema.ChatMessageEntity", b =>
                {
                    ...
                    b.Property<string>("CustomAuthorName")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Bottleneko.Database.Schema.Protocols.Discord.DiscordChatMessageEntity", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("ChannelMentions")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("IsEveryoneMentioned")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsPinned")
                        .HasColumnType("INTEGER");

                    b.PrimitiveCollection<string>("RoleMentions")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.PrimitiveCollection<string>("UserMentions")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Bottleneko.Database.Schema.Protocols.Twitch.TwitchChatBadgeEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("TwitchChatMessageId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("TwitchSetId")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.HasIndex("TwitchChatMessageId");

                    b.ToTable("TwitchChatBadgeEntity");
                });
            ...
            modelBuilder.Entity("Bottleneko.Database.Schema.Protocols.Twitch.TwitchChatMessageEntity", b =>
                {
                    ...
                    b.Property<string>("ChannelPointsCustomRewardId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Bottleneko.Database.Schema.Protocols.Twitch.TwitchChatBadgeEntity", b =>
                {
                    b.HasOne("Bottleneko.Database.Schema.Protocols.Twitch.TwitchChatMessageEntity", "TwitchChatMessage")
                        .WithMany("Badges")
                        .HasForeignKey("TwitchChatMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TwitchChatMessage");
                });

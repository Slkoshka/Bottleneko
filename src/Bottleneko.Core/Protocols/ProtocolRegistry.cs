...
public record ProtocolDescription(Protocol Id, DynamicConnectionFactory Factory, DynamicConnectionTest Test, Type ConfigType)
{
    public static ProtocolDescription Make<TConfig>(Protocol id, StaticConnectionFactory<TConfig> factory, StaticConnectionTest<TConfig> test) where TConfig : ProtocolConfiguration
    {
        return new(
            id,
